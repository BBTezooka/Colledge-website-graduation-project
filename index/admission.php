...
<head>
    ...
    <link rel="stylesheet" href="styles/admission.css?<?echo time();?>">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400;1,500;1,600&family=Oswald:wght@200;300;400;500;600&display=swap" rel="stylesheet">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
...
<body>
    ...
    <main>
        <div class="main-info-holder">
            <div class="main-info">
                <div class="commisia big-yellow-p">
                    <span>Документы приемной комиссии 2023</span>
                    <ul>
                        <li>План приема на 2023/2024 учебный год</li>
                        <li>Правила приема на 2023/2024 учебный год</li>
                        <li>Поступление в колледж 2023</li>
                        <li>Приказ о наборе на базе среднего общего образования 2023-24 уч.год</li>
                        <li>Приказ о наборе на заочное обучение по специальности Промышленное рыболоство</li>
                        <li>Приказ о ранжировании абитуриентов, имеющих одинаковый средний балл</li>
                        <li>График заключения договоров на обучение</li>
                        <li>Приказ о стоимости обучения на 2023/2024 учебный год</li>
                        <li>Сроки проведения организационных собраний 2023</li>
                    </ul>
                </div>
                <div class="documents big-yellow-p">
                    <span>Бланки документов</span>
                    <p>Данный пакет документов необходимо скачать и заполнить вручную только при подаче документов через операторов Почтовой связи или посредством Электронной формы подачи документов на сайте КМРК.</p>
                    <p>При личном обращении в приемную комиссию колледжа все документы заполняются на месте.</p>
                    <ul>
                        <li>Заявление о приеме на обучение</li>
                        <li>Согласие родителя (законного представителя) на обработку персональных данных несовершеннолетнего поступающего</li>
                        <li>Согласие на обработку персональных данных совершеннолетнего поступающего</li>
                        <li>Анкета для поступающих на очную форму обучения</li>
                        <li>Правила ношения, приобретения и соблюдения формы одежды (для морских специальностей)</li>
                        <li>Подача документов на поступление в колледж по доверенности (для заочной формы обучения)</li>
                        <li>Согласие на привлечение хозяйственным работам</li>
                    </ul>
                </div>
                <div class="sposob-podachi big-yellow-p">
                    <span>Способы подачи документов</span>
                    <p>В случае невозможности прибытия абитуриента в приемную комиссию оригиналы документов могут быть поданы по почте или через законного представителя, действующего на основании доверенности, удостоверенной нотариально.</p>
                    <p> В 2023 году поступающие вправе направить заявление о приёме, а также необходимые документы одним из следующих способов:</p>
                    <ul>
                        <li>Лично в образовательную организацию</li>
                        <li>Через операторов почтовой связи общего пользования (по почте) по адресу: Калининградский морской рыбопромышленный колледж БГАРФ ФГБОУ ВО «КГТУ», 236039, Россия, г. Калининград, ул. Мореходная, д.3. Документы, направленные по почте, принимаются при их поступлении в колледж для поступления на очную и заочную формы обучения не позднее 15 августа</li>
                        <li>В электронном виде (документ на бумажном носители, преобразованный в электронную форму путем сканирования или фотографирования с обеспечением машиночитаемого распознавания его реквизитов) посредством электронной информационной системы колледжа с использованием функционала официального сайта колледжа. Бланки документов должны быть распечатаны, заполнены от руки и подписаны. Если абитуриент не имеет возможности отсканировать пакет документов, допускается фотографирование. Документы необходимо сканировать или фотографировать в раскрытом виде: паспорт – 2 разворота (главный, прописка), аттестат современного образца – 3 разворота (аттестат + приложение с двух сторон).</li>
                    </ul>
                    <p>Изображение должно быть четким, без посторонних предметов. Форма для электронной подачи заявлений будет доступна с 20 июня с 10 утра до 15 августа до 18.00. По адресам электронных почт КМРК документы для поступления не принимаются.</p>
                    <p>Приемная комиссия рассматривает к зачислению лиц, предоставивших оригиналы документов об образовании и (или) документов об образовании и о квалификации в срок до 15 августа (18 часов – время местное). Предоставить оригинал документа можно лично или через операторов почтовой связи.</p>
                </div>
                <div class="spec-info big-yellow-p">
                    <span>Списки на специальность:</span>
                <?php
                                $spec = "SELECT * FROM `Specialnost`";
                                $spec_run = mysqli_query($db, $spec);
                                if (mysqli_num_rows($spec_run) > 0) {
                                ?>
                                    <div class="form-group">
                                        <form action="" method='POST'>
                                            <select tabindex="10" name="ID_Spec">
                                                <option value="">Специальность</option>
                                                <?php
                                                foreach ($spec_run as $row) {
                                                ?>
                                        ...
                                        <script>
                                            $(document).ready(function() {
                                                $('select[name="ID_Spec"]').change(function() {
                                                    var ID_Specialnost = $(this).val();

                                                    $.ajax({
                                                        type: 'POST',
                                                        url: 'get_awesome_students.php', // Укажите здесь путь к файлу обработчику
                                                        data: {ID_Specialnost: ID_Specialnost},
                                                        success: function(response) {
                                                            // Обновляем блок с данными
                                                            $('#awesome_students_list').html(response);
                                                        }
                                                    });
                                                    $.ajax({
                                                        type: 'POST',
                                                        url: 'get_notawesome_students.php', // Укажите здесь путь к файлу обработчику
                                                        data: {ID_Specialnost: ID_Specialnost},
                                                        success: function(response) {
                                                            // Обновляем блок с данными
                                                            $('#not_awesome_students_list').html(response);
                                                        }
                                                    });
                                                });
                                            });
                                        </script>
                                            <div class="students_list-holder">
                                                <span>Бюджет</span>
                                                <div id="awesome_students_list">
                                                    <p>Выберете специальность</p>
                                                </div>
                                                <span>Коммерция</span>
                                                <div id="not_awesome_students_list">
                                                    <p>Выберете специальность</p>
                                                </div>
                                            </div>
                                    </div>
            ...
            <div class="big-form">
                <form action="insert.php"  method="post">
                    <div class="inside-form">
                        <h3>Форма анкеты абитуриента</h3>
                        <div class="form-content">
                            <div class="student-info">
                                <p>ИНФОРМАЦИЯ О СТУДЕНТЕ</p>
                                <input type="text" placeholder="ФИО" name = 'fio_a'>
                                <input type="text" placeholder="Адрес проживания" name = 'adres_a'>
                                <input type="text" placeholder="Номер телефона" name = 'nomer_a'>
                                <input type="text" placeholder="E-mail" name = 'email_a'>
                                <input type="text" placeholder="Хобби,спорт, увлечения и др." name = 'dop_a'>
                                <input type="text" placeholder="Средний балл" name = 'sr_bal'>
                                <?php
                                ...
                                ?>
                                    <div class="form-group">
                                        <form action="" method='POST'>
                                            <select tabindex="10" name="ID_Specialnost">
                                                <option value="">Специальность для поступления</option>
                                                <?php
                            ...
                            <div class="mother-info">
                                <p>ИНФОРМАЦИЯ О МАТЕРИ (ЗАКОННОМ ПРЕДСТАВИТЕЛЕ)</p>
                                <input type="text" placeholder="ФИО" name = 'fio_m'>
                                <input type="text" placeholder="Адрес проживания" name = 'adres_m'>
                                <input type="text" placeholder="Номер телефона" name = 'nomer_m'>
                                <input type="text" placeholder="E-mail" name = 'email_m'>
                                <input type="text" placeholder="Место работы" name = 'mesto_m'>
                                <input type="text" placeholder="Должность" name = 'dolzh_m'>
                            </div>
                            <div class="father-info">
                                <p>ИНФОРМАЦИЯ ОБ ОТЦЕ</p>
                                <input type="text" placeholder="ФИО" name = 'fio_o'>
                                <input type="text" placeholder="Адрес проживания" name = 'adres_o'>
                                <input type="text" placeholder="Номер телефона" name = 'nomer_o'>
                                <input type="text" placeholder="E-mail" name = 'email_o'>
                                <input type="text" placeholder="Место работы" name = 'mesto_o'>
                                <input type="text" placeholder="Должность" name = 'dolzh_o'>
                            </div>
                            <div class="button-holder">
                                <button type="submit" name="submit_button">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="20" viewBox="0 0 24 20" fill="none">
                                        <path d="M0 10.8511L8.21842 20L24 2.48255L21.7341 0L8.21842 14.9998L2.23514 8.35149L0 10.8511Z" fill="#F4CA2F"/>
                                    </svg>
                                    Поступить
                                </button>
                            </div>
