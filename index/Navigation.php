		...
		<section id="management">
			<div class="maneg-container">
				<div class="maneg-inner">
					<h3>РУКОВОДСТВО</h3>
					<h4>КОНТАКТЫ</h4>
					<p class="adres">г. Калининград, ул. Мореходная 3, учебный корпус №1, этаж 3, каб. 1314</p>
					<p class="mail">svo@kmrk.ru</p>
					</p>
					<br>
					<hr>
					<br>
					<p><img src="assets/images/manegement/feoktistov 1.png"></p>
					<h3>НАЧАЛЬНИК КОЛЛЕДЖА</h3>
					<h4>Феоктистов Владимир Владимирович</h4>
					<p class="info-feoktistov">Награждён Медалью Чести I степени за поддержку Уставной деятельности Организации, личный вклад в искоренении коррупционных схем, личное мужество и патриотизм     </p>
					<br>
					<hr>
					<br>
					<h3>ЗАМЕСТИТЕЛЬ ЗАВЕДУЮЩЕГО ОТДЕЛЕНИЕМ</h3>
					<h4>Житков Владимир Николаевич </h4>
					<br>
					<hr>
					<br>
					<h3>ДИСПЕТЧЕР УЧЕБНОГО ОТДЕЛЕНИЯ (ПО ЗАОЧНОЙ ФОРМЕ ОБУЧЕНИЯ)</h3>
					<h4>Подовинникова Юлия Андреевна</h4>
					<p class="mail-Podovinnikova">yu.podovinnikova@kmrk.ru</p>
				</div>
			</div>
		</section>
		...
		<section id="college-info">
			<div class="container">
				<div class="info-inner">
					<p>О направлении подготовки специалистов среднего звена базового уровня:
                    </p>
					<br>
					<p>Курсанты получают знания и навыки в области судовождения, технологий перевозки грузов, ведения промысла, эксплуатации всех палубных механизмов, изучают основы и особенности навигации и лоции, обеспечения безопасности плавания судов, предотвращения загрязнения окружающей среды. В процессе обучения изучаются современные компьютерные программы.
                    </p>
					<br>
					<p>Подготовка ведётся в соответствии с требованиями Международной конвенции и Кодекса по подготовке и дипломировании моряков и несении вахты (ПДНВ-78 с поправками), имеет сертификацию DNV Certification OY/AB (Финляндия) на соответствие системы менеджмента качества стандарту и позволяет выпускникам занимать должности командного состава на рыбопромысловых и морских судах России и иностранных государств.
                    </p>
					<br>
                    <p> Обучение ведется в соответствии с ФГОС, Международной конвенцией ПДНВ и Кодексом ПДНВ.<p>
					<br>
					<p>Профессиональные дисциплины</p>
					<p>— Теория и устройство судна    </p>
                    <p>— Навигация, навигационная гидрометеорология и лоция</p>
                    <p>— Управление судном и технические средства судовождения</p>
                    <p>— Механика </p>
                    <p>— Инженерная графика</p>
                    <p>— Материаловедение</p>
                    <p>— Электротехника и электроника                    </p>
                    <p>— Правовые основы профессиональной деятельности </p>
                    <p>— Метрология и стандартизация Безопасность жизнедеятельности</p>
                    <p>— Безопасность жизнедеятельности на судне и транспортная безопасность</p>
                    <p>— Технология перевозки грузов </p>
					<br>
					<p>Полученные знания позволят </p>
                    <P>— определять местоположения судна, планировать переход в точку назначения, маневрировать и управлять судном,</P>
                    <P>— обеспечивать техническую эксплуатацию технических средств судовождения и судовых систем связи,</P>
                    <P>— контролировать погрузку, размещение, крепление груза и уход за ним в течение рейса и выгрузки, организовывать безопасное выполнение этих действий,                    </P>
                    <P>— организовывать действия подчиненных членов экипажа судна при организации учебных пожарных тревог, предупреждения возникновения пожара и при тушении пожара, при авариях, при оставлении судна, использовать спасательные шлюпки, спасательные плоты и иные спасательные средства, применять средства по борьбе за живучесть судна,                    </P>
                    <P>— оказывать первую медицинскую помощь пострадавшим,</P>
                    <P>— контролировать действия подчиненных членов экипажа судна по предупреждению и предотвращению загрязнения водной среды,</P>
                    <P>— соблюдать меры предосторожности во время погрузки и выгрузки и обращения с опасными и вредными грузами во время рейса, </P>
					<P>— организовывать мероприятия по обеспечению транспортной безопасности.</P>
					<p>Федеральное агентство по рыболовству</p>
					<br>
					<p>Трудоустройство выпускников </p>
					<p>Рыбодобывающие, транспортные, все современные суда, администрации портов, службы флота.</p>
					<br>
					<p>Специальность позволяет стать:</p>
                    <P>— вахтенным помощником капитана</P>
                    <P>— старшим помощником капитана,</P>
                    <P>— капитаном.</P>
                    <P>— Программа обучения предусматривает освоение рабочей профессии с присвоением квалификации:
                        матрос, вахтенный матрос.</P>
